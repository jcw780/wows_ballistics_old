...
var opts=Object.defineProperty({},"passive",{get:function(){supportsPassive=!0}}),touchEvent="ontouchstart"in window?"touchstart":"click",computationMethod="FE",inputData=Object.seal({mv:[805,805],caliber:[.102,.102],krupp:[2300,2300],mass:[15.2,15.2],normal:[10,10],cD:[.3536,.3536],threshold:[17,17],fusetime:[.01,.01],ra0_:[45,45],ra1_:[60,60],HESAP:[0,0],shellType:["AP","AP"],angle:[0,5,10,15,20,25,30,35],armor:70,inclination:0,width:18,shipName:["Vampire 0","Vampire 0"]}),graphSettings=Object.seal({minDist:"0",
maxDist:"",tickDist:"1000",rounding:"3",enableFills:!1,shortNames:!0}),autoApply=[!0,!0];function setComputation(a){computationMethod=a}
...
this.checked},["enableFills","shortNames"]],[function(){autoApply[parseInt(this.id.slice(-1))]=this.checked},["autoApply0","autoApply1"]],[function(){console.log(this);graphShip[this.id.slice(-1)]=this.checked},["graphShip0","graphShip1"]]].map(function(a){a[1].map(function(b){document.getElementById(b).addEventListener(touchEvent,a[0],opts)})})}addTitles();document.getElementById("generate").addEventListener(touchEvent,collectMake,opts);
function changeChevron(a){a.stopPropagation();$(a.target).prev("button").find("span.fa").toggleClass("fa-chevron-up fa-chevron-down")}
...
parseFloat(graphSettings.tickDist));targetedArmor="Armor Thickness: "+m+"mm";targetInclination="Vertical Inclination: "+q+"°";makeImpactCharts();makeAngleCharts();makePostPenCharts();v.jumpToEnd()})}
...
b){var d=a.label,e=a.value;return 0==a.datasetIndex%2?c[0](d,e):c[1](d,e)}}}function penetrationToolTipLabel(a,b){return"("+a+"m, "+b+"mm)"}function angleTooltipLabel(a,b){return"("+a+"m, "+b+"°)"}function velocityTooltipLabel(a,b){return"("+a+"m, "+b+"m/s)"}function timeTooltipLabel(a,b){return"("+a+"m, "+b+"s)"}function filterLegend(a,b){return"_remove_"!=a.text}var commonPointRadius=0,graphShip=[!0,!0],colors=[["#3e95cd","#FFA500","#FFD700"],["#008000","#FF0000","#FF0090"]];
...
scales:{xAxes:xAxesDistance,yAxes:[{id:"angle",postition:"left",scaleLabel:{display:!0,labelString:"Lateral Angle (°)"},ticks:{min:0}}]},legend:{labels:{filter:filterLegend}},animation:animationCommon}};addTooltipCallbackAngles(e);graphShip.map(function(a,b){if(a&&(e.data.datasets.push({data:c[b+6],showLine:!0,label:"Minimum Fusing Angle "+shipName[b],yAxisID:"angle",backgroundColor:Samples.utils.transparentize(colors[b][0]),borderColor:colors[b][0],fill:!1,pointRadius:commonPointRadius,pointHitRadius:5},
{data:c[3*b+1],showLine:!0,borderDash:[5,5],label:"Start Ricochet "+shipName[b],yAxisID:"angle",backgroundColor:Samples.utils.transparentize(colors[b][1]),borderColor:colors[b][1],fill:!1,pointRadius:commonPointRadius,pointHitRadius:5},{data:c[3*b+2],showLine:!0,borderDash:[5,5],label:"Always Ricochet "+shipName[b],yAxisID:"angle",backgroundColor:Samples.utils.transparentize(colors[b][2]),borderColor:colors[b][2],fill:!1,pointRadius:commonPointRadius,pointHitRadius:5}),graphSettings.enableFills)){var d=
...
function makePostPenCharts(){var a,b,c,d,e,f,k,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){1==g.nextAddress&&(document.getElementById("width"),a="Fused ",b="No Fusing ",c=[],d={$jscomp$loop$prop$i$22$24:0});if(5!=g.nextAddress){if(!(d.$jscomp$loop$prop$i$22$24<numAngles))return g.jumpTo(0);e="Lateral Angle "+d.$jscomp$loop$prop$i$22$24+": "+v_angles[d.$jscomp$loop$prop$i$22$24]+"°";document.getElementById("AT"+d.$jscomp$loop$prop$i$22$24).textContent=e;f=[[0,2,Module.postPenDataIndex.xwf.value,
...
borderColor:"#505050",fill:!1,pointRadius:commonPointRadius,pointHitRadius:5}]},options:{title:{display:!0,text:"Internal Width Traveled before Detonation | "+targetedArmor+" | "+targetInclination+" | Horizontal Impact Angle: "+v_angles[d.$jscomp$loop$prop$i$22$24]+"°"},scales:{xAxes:xAxesDistance,yAxes:[{scaleLabel:{display:!0,labelString:"Shell Detonation Distance (m)"}}]},animation:animationCommon}};addTooltipCallbackPostPen(c[d.$jscomp$loop$prop$i$22$24]);graphShip.map(function(d){return function(e,
