...
var opts={passive:!0},touchEvent="ontouchstart"in window?"touchstart":"click",computationMethod="FE",inputData=Object.seal({mv:[805,805],caliber:[.102,.102],krupp:[2300,2300],mass:[15.2,15.2],normal:[10,10],cD:[.3536,.3536],threshold:[17,17],fusetime:[.01,.01],ra0_:[45,45],ra1_:[60,60],HESAP:[0,0],shellType:["AP","AP"],angle:[0,5,10,15,20,25,30,35],armor:70,inclination:0,width:18,shipName:["Vampire 0","Vampire 0"]}),graphSettings=Object.seal({minDist:"0",maxDist:"",tickDist:"1000",rounding:"3",enableFills:!1,
shortNames:!0}),autoApply=[!0,!0];function setComputation(a){computationMethod=a}
